...
class MyMenuTableViewController: UITableViewController {
    ...
    var products = ["Find restaurants near you","Find restaurant by name", "Find by street name", "Find restaurant by cuisine","Find restaurant by food"]
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell!.textLabel!.text = products[(indexPath as IndexPath).row]
